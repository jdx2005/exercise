...
class RNN_model(nn.Module):
    ...
    def forward(self,sentence,is_test = False):
        ...
        h0 = torch.zeros(2, batch_input.size(0), self.lstm_dim, device=device)  # (num_layers, batch, hidden)
        c0 = torch.zeros(2, batch_input.size(0), self.lstm_dim, device=device)  # (num_layers, batch, hidden)
